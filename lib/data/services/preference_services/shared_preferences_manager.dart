...
class SharePreferencesManager {
  ...
  Future<void> saveUserId({required String userID}) async {
    _sharePreferences.setString(PreferenceKeys.userID.name, userID);
  }

  String? getUserID() {
    return _sharePreferences.getString(PreferenceKeys.userID.name);
  }

  Future<bool> removeUserID() async {
    return _sharePreferences.remove(PreferenceKeys.userID.name);
  }
}
