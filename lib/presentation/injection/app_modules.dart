...
class AppModules {
  static Future<void> inject() async {
    ...
    injector.registerLazySingleton<Dio>((){
      final notFound404Interceptor= NotFound404Interceptor(
        injector.get<NetworkActionManager>()
      );
      return DioHelper.configDio(notFound404Interceptor: notFound404Interceptor,);
    }
    );

    injector.registerLazySingleton<NetworkActionManager>(() => NetworkActionManager(),);
    ...
    injector.registerLazySingleton<GetUserCredentialUseCase>(
