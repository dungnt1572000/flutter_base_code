...
class AppModules {
  static Future<void> inject() async {
    ...
    injector.registerLazySingleton<QuestionRepository>(
      () => QuestionRepository(injector.get<ApiClient>()),
    );
    injector.registerLazySingleton<GetQuestionCategoryUseCase>(
      () => GetQuestionCategoryUseCase(),
    );
  }
}
