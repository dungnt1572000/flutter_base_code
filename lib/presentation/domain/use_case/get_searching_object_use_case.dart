...
class GetSearchingObjectUseCase implements FutureUseCase<SeachingObjectInput, SearchingObject>{
  @override
  Future<SearchingObject> run(SeachingObjectInput input) async {
    return await injector.get<UserMapRepository>().getSearchingObject(input.places, input.accessToken);
  }
